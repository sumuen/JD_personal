...
[task_local]
# 7日签到每日版
0 0 * * *  t_sevenDay_sign_day.js, tag=7日签到每日版, enabled=true
 */
            ...
            case 'getSimpleActInfoVo':
                if (typeof res == 'object') {
                    if (res.result && res.result === true) {
                        ...
                        $.jdActivity = res.data.jdActivity
